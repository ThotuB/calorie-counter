...
impl DailyDto {
    pub fn empty(date: chrono::NaiveDate, macro_goal: MacroGoal) -> Self {
        Self {
            date,
            calories: 0,
    ...
    pub fn new(date: chrono::NaiveDate, macro_goal: MacroGoal, meals: Vec<MealDto>) -> Self {
        let mut daily = Self::empty(date, macro_goal);
