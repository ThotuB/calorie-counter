...
impl StatsDto {
    pub fn empty(date: chrono::NaiveDate, macro_goal: &MacroGoal, clw: [i32; 7]) -> StatsDto {
        StatsDto {
            date,
            calories: 0,
...
impl StatsMacroPercentagesDto {
    pub fn empty() -> StatsMacroPercentagesDto {
        StatsMacroPercentagesDto {
            carbs: 0.0,
            fat: 0.0,
            protein: 0.0,
        }
    ...
    pub fn new(carbs: f32, fat: f32, protein: f32) -> StatsMacroPercentagesDto {
        StatsMacroPercentagesDto {
            carbs,
            fat,
            protein,
