...
export const usdaSearchFoodToFood = (food: SearchResultFoodDto): Food => {
    return {
        ...
        alternateServingSize: '1 serving',
        verified: false,
        nutrients: {
            ...
            saturatedFat: getSearchNutrientValue(food.foodNutrients, 1258),
            unsaturatedFat: getSearchNutrientValue(food.foodNutrients, 1257),
        },
        vitamins: {
            show: false,
...
export const usdaFoodToFood = (food: FoodDto): Food => {
    return {
        ...
        nutrients: {
            ...
            saturatedFat: getIdNutrientValue(food.foodNutrients, 1258),
            unsaturatedFat: getIdNutrientValue(food.foodNutrients, 1257),
        },
        vitamins: {
            show: false,
